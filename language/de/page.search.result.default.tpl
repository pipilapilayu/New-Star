...
<table style="width:760px" id="resulttable">
	...
	<tr>
		...
		<td><a href="#" onclick="return Dialog.PM({$searchRow.userid});" title="{$LNG.sh_write_message}"><img src="{$dpath}img/iconav/mesages.png"/></a>&nbsp;<a href="#" onclick="return Dialog.Buddy({$searchRow.userid});" title="{$LNG.sh_buddy_request}"><img src="{$dpath}img/iconav/friend.png" border="0"></a></td>
